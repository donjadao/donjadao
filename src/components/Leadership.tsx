...
const leadershipRoles = [
  {
    ...
    type: 'Club',
    period: 'October2023 - May 2026',
    description: 'Launched a UX Design club in 2023 and grew it to over 200 members, creating the brand identity, running communications, and designing hands‑on workshops that introduced students to UX principles and leadership skills.',
    icon: Heart,
    color: '#d03674',
    image: UX,
  },
  {
    ...
    description: 'I helped grow SASEs digital presence by more than 300%, led the design of our most successful graphic tee to date, and build standartized templates to streamline how our three person marketing team collaborated.',
    icon: Users,
    color: '#7484bc',
    image: SASE,
  },
